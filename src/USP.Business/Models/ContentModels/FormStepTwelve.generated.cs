...
{
	/// <summary>[Form] Application Form Step Twelve</summary>
	[PublishedContentModel("formStepTwelve")]
	public partial class FormStepTwelve : PublishedContentModel, IBaseForm, IBaseHeading, IBaseMetaInformation, IBaseNavigation
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "formStepTwelve";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public FormStepTwelve(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<FormStepTwelve, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// How Did You Hear About This Course Drop Down List: The first option is the not selected
		///</summary>
		[ImplementPropertyType("dropDownListHowDidYouHearAboutThisCourse")]
		public IEnumerable<string> DropDownListHowDidYouHearAboutThisCourse
		{
			get { return this.GetPropertyValue<IEnumerable<string>>("dropDownListHowDidYouHearAboutThisCourse"); }
		}

		///<summary>
		/// Most Interested Sector Drop Down List: The first option is the not selected
		///</summary>
		[ImplementPropertyType("dropDownListMostInterestedSector")]
		public IEnumerable<string> DropDownListMostInterestedSector
		{
			get { return this.GetPropertyValue<IEnumerable<string>>("dropDownListMostInterestedSector"); }
		}

		///<summary>
		/// How Did You Hear About This Course Drop Down Label
		///</summary>
		[ImplementPropertyType("labelHowDidYouHearAboutThisCourseDropdown")]
		public string LabelHowDidYouHearAboutThisCourseDropdown
		{
			get { return this.GetPropertyValue<string>("labelHowDidYouHearAboutThisCourseDropdown"); }
		}

		///<summary>
		/// Most Interested Sector Label
		///</summary>
		[ImplementPropertyType("labelMostInterestedSector")]
		public string LabelMostInterestedSector
		{
			get { return this.GetPropertyValue<string>("labelMostInterestedSector"); }
		}

		///<summary>
		/// Receive Marketing E-mails Checkbox Label
		///</summary>
		[ImplementPropertyType("labelReceiveMarketingEmailsCheckbox")]
		public string LabelReceiveMarketingEmailsCheckbox
		{
			get { return this.GetPropertyValue<string>("labelReceiveMarketingEmailsCheckbox"); }
		}
