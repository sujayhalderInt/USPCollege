...
{
	/// <summary>[Page] News Detail</summary>
	[PublishedContentModel("pageNewsDetail")]
	public partial class PageNewsDetail : PublishedContentModel, IBaseArticleGrid, IBaseContent, IBaseContentBanner, IBaseMetaInformation, IBaseNavigation
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "pageNewsDetail";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public PageNewsDetail(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<PageNewsDetail, TValue>> selector)
		{
		...
		/// Topics
		///</summary>
		[ImplementPropertyType("newsTopics")]
		public IEnumerable<IPublishedContent> NewsTopics
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("newsTopics"); }
		}
