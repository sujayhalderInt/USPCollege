...
{
	/// <summary>[Form] Application Form Step Eight</summary>
	[PublishedContentModel("formStepEight")]
	public partial class FormStepEight : PublishedContentModel, IBaseForm, IBaseHeading, IBaseMetaInformation, IBaseNavigation
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "formStepEight";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public FormStepEight(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<FormStepEight, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Sport Academies Check Box List
		///</summary>
		[ImplementPropertyType("checkboxListSportAcademies")]
		public IEnumerable<string> CheckboxListSportAcademies
		{
			get { return this.GetPropertyValue<IEnumerable<string>>("checkboxListSportAcademies"); }
		}
