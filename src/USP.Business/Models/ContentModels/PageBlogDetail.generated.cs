...
{
	/// <summary>[Page] Blog Detail</summary>
	[PublishedContentModel("pageBlogDetail")]
	public partial class PageBlogDetail : PublishedContentModel, IBaseArticleGrid, IBaseContent, IBaseContentBanner, IBaseMetaInformation, IBaseNavigation
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "pageBlogDetail";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public PageBlogDetail(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<PageBlogDetail, TValue>> selector)
		{
		...
		public IEnumerable<IPublishedContent> BlogAuthor
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("blogAuthor"); }
		}

		///<summary>
		/// Topics
		///</summary>
		[ImplementPropertyType("blogTopics")]
		public IEnumerable<IPublishedContent> BlogTopics
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("blogTopics"); }
		}
