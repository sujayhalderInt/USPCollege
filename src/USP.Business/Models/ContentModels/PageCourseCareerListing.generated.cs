...
{
	/// <summary>[Page] Course/Career Listing</summary>
	[PublishedContentModel("pageCourseCareerListing")]
	public partial class PageCourseCareerListing : PublishedContentModel, IBaseContentBanner, IBaseMetaInformation, IBaseNavigation
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "pageCourseCareerListing";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public PageCourseCareerListing(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<PageCourseCareerListing, TValue>> selector)
		{
		...
		///</summary>
		[ImplementPropertyType("courseListingFilters")]
		public IEnumerable<IPublishedContent> CourseListingFilters
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("courseListingFilters"); }
		}

		///<summary>
		/// Course or Career Filter Title
		///</summary>
		[ImplementPropertyType("courseOrCareerFilterTitle")]
		public string CourseOrCareerFilterTitle
		{
			get { return this.GetPropertyValue<string>("courseOrCareerFilterTitle"); }
		}
