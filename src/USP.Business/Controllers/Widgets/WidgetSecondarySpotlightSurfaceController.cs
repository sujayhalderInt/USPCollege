...
{
    public class WidgetSecondarySpotlightSurfaceController : DocTypeGridEditorSurfaceController
    {
        public ActionResult WidgetSecondarySpotlight()
        {
            var model = new WidgetSecondarySpotlight(Model);
